...
const Skills = ({ label, svg, faClass }) => {
    return (
        <span data-aos="fade-up" className="skill__square col-3 col-sm-2 my-3 mx-auto" style={{width:"auto",textAlign: 'center'}}>
            ...
            {svg ?  <Image src={svg} alt="" rounded style={{width:"5rem"}}></Image> : <i className={`${faClass} mx-auto my-auto`}></i>}
